...
const NavBar = () => {
    ...
    return (
        <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
            <div>
                <img src={Logo} alt='Ayan Navalur' style={{width: '50px'}} />
            </div>
            {/* Menu */}
            ...
            <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
                <ul >
                    <li className='w-[130px] h-[60px] flex justify-between items-center ml-[-78px] hover:ml-[-5px] duration-300 bg-blue-600'>
                        <a className='flex justify-between items-center w-full text-gray-300' href='https://www.linkedin.com/in/ayan-sh/'>LinkedIn <FaLinkedin size={30}/></a>
                    </li>
                    ...
                    <li className='w-[130px] h-[60px] flex justify-between items-center ml-[-78px] hover:ml-[-5px] duration-300 bg-[#6fc2b0]'>
                        <a className='flex justify-between items-center w-full text-gray-300' href='mailto:ayan.n@myjobemails.com'>Email <HiOutlineMail size={30}/></a>
                    </li>
                    <li className='w-[130px] h-[60px] flex justify-between items-center ml-[-78px] hover:ml-[-5px] duration-300 bg-[#565f69]'>
                        <a className='flex justify-between items-center w-full text-gray-300' href='https://drive.google.com/uc?export=download&id=1M7WM6MeYAF1PddLpwZpxqY1YRdVwgFul'>Resume <BsFillPersonLinesFill size={30}/></a>
                    </li>
                </ul>
            </div>
        </div>
